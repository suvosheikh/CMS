...
const App: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (user) {
      ...
      setCurrentUser(user);
      // Forcing a clean state transition
      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
        <div className="max-w-md w-full bg-white rounded-[3rem] shadow-2xl shadow-slate-200 border border-slate-100 overflow-hidden">
          ...
          <form onSubmit={handleLogin} className="p-10 space-y-6">
            ...
            <button className="w-full py-5 bg-blue-600 text-white rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl shadow-blue-100 flex items-center justify-center gap-3 active:scale-[0.98]">
